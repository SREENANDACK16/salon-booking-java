...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="assets/css/searchsalon.css">
</head>
<body>
...
<c:forEach var="salon" items="${salons}">
    <div class="salon-card">
        ...
        <c:if test="${not empty salon.photo}">
           <%
com.proj.bsb.bean.Salon s =
(com.proj.bsb.bean.Salon) pageContext.findAttribute("salon");

if(s != null && s.getPhoto() != null){
    String base64Image =
    Base64.getEncoder().encodeToString(s.getPhoto());
%>
...
%>
        ...
        <div class="nav-buttons">
                ...
                <a href="CustomerReg.jsp">BOOK NOW</a>
