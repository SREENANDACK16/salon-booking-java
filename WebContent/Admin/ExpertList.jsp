<%@ page import="java.util.*, com.proj.bsb.bean.*, com.proj.bsb.service.AdminService" %>
...
<%
    ...
    List<Experts> expertList =
            (List<Experts>) request.getAttribute("expertList");

    if(expertList == null){
        expertList = service.getAllExperts();
    }

    List<Salon> salonList = service.getAllSalons();

    int count = expertList.size();
%>
<!DOCTYPE html>
<html>
<head>
    ...
    <div class="main-content">
        ...
        <div class="top-header">
            <div>
                ...
                <p>Manage salon experts and staff details</p>
            </div>
        </div>
            ...
            <div class="table-responsive">
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td>
                            <%= service.getSalonById(e.getSalonId()).getSalonName() %>
                        </td>
